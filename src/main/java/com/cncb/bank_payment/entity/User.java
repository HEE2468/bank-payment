...
public class User {
    ...
    public User(String user_id, String user_tel, String user_name, String idenity, String user_paw) {
    ...
    public User(String user_tel, String user_name, String idenity, String user_paw) {
        this.user_id = user_id;
        this.user_tel = user_tel;
        this.user_name = user_name;
        this.idenity = idenity;
